...
def predict(image_name):
    ...
    class_name = decode_pred[0][0][1]
    pred_probability = float(decode_pred[0][0][2])
...
def classify_process():
    ...
    received, then, run our ML model to get predictions.
    """
    logging.info('xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx')
    while True:
        ...
        queue_name, job = db.brpop('service_queue')
